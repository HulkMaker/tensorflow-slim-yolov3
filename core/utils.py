...
def gpu_nms(boxes, scores, num_classes, max_boxes=50, score_thresh=0.001, iou_thresh=0.5):
    """
    /*----------------------------------- NMS on gpu ---------------------------------------*/
...
def draw_boxes(image, boxes, scores, labels, classes, detection_size,
               font='./data/font/FiraMono-Medium.otf', is_show=True):
    """
    ...
    image.show() if is_show else None
