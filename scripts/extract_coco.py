...
def main(argv):
    ...
    parser.add_argument("--json_path", default='/home/qing/coco/annotations/instances_val2014.json')
    parser.add_argument("--image_path", default="/home/qing/coco/images/val2014")
    #parser.add_argument("--dataset_info_path", default="./data/train2017.txt")
    parser.add_argument("--dataset_info_path", default="./data/val.txt")
    ...
    with open(os.path.realpath(flags.dataset_info_path), 'w') as f:
        ...
        for annotation in annotations:
            ...
            single_image_path = os.path.join(image_folder_path, 'COCO_val2014_%012d.jpg' %image_id)
